...
export default function TextSurveyPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setPayload(json);
      await logEvent("text_page_view", { page: "/survey_v1/text", survey_version: "survey_v1" });
    })();
  }, []);
